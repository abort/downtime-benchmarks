...
LOAD_USERS=64
RAMPUP_TIME=10
PREMIGRATION_TIME=10
POST_MIGRATION_TIME=10
...
BENCHMARK_COMMAND="-v $BENCHMARK_DB_CONFIG -su $SCHEMA_USERS -lu $LOAD_USERS -w $WAREHOUSES -r $RAMPUP_TIME -b $PREMIGRATION_TIME -a $POST_MIGRATION_TIME -n $CHANGE_NAME -o outputs -m $CHANGE_FILE $COMMAND_SUFFIX"
